                    ...
                    <section>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <select class="custom-select required" id="custom-select" name="marital-status" required>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <textarea class="form-control required" name="currentAddress" id="example-textarea" rows="3"
                            required></textarea>
                        </div>

                        <div class="form-group col-md-6">
                          <label for="form-control">Permanent Address *</label>
                          <textarea class="form-control required" name="permanentAddress" id="example-textarea" rows="3"
                            required></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <textarea class="form-control" name="qualifications" id="example-textarea"
                            rows="4"></textarea>
                        </div>
