                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0 text-muted">
                                <strong class="mb-0 text-muted designation-name"
              ...
              <form id="newForm">
                ...
                <div class="form-row">
                  <div class="form-group col-6">
                    ...
                    <select id="department-id" class="form-control select2 required" required name="department-id"
                      required>
                      <?php
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $(document).on('click', '.edit-button', function () {
        ...
        $('#edit-designation-name').val(designationName); $('#edit-designation-name').val(designationName);
