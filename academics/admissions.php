...
<head>
  ...
  <title>Admission History - Rinda AMS</title>
  <!-- Simple bar CSS -->
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          $sql = "SELECT s.admission_no, CONCAT(s.firstName, ' ', s.lastName) AS full_name, c.class, sessions.session AS session, 
                CASE 
            ...
            INNER JOIN sessions ON s.session = sessions.id";
                        ...
                        foreach ($students as $index => $student): ?>
                          <tr>
                            ...
                            <td>
                              <?= ($student['term'] == 1) ? 'First Term' : (($student['term'] == 2) ? 'Second Term' : 'Third Term') ?>
                            </td>
                            <td>
                              <?= $student['session'] ?>
                            </td>
