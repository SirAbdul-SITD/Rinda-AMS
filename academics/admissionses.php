                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Grade 4</td>
                          <td>Second Term</td>
                          <td>2023/2024</td>                          <td>(478) 446-9234</td>
                          <td>Jun 8, 2019</td>
                        ...
                        <tr>
                          <td>1</td>
                          <td>Imani Lara</td>
                          <td>Grade 4</td>                          <td>Second Term</td>
                          <td>2023/2024</td>
                          <td>(478) 446-9234</td>
                          <td>Jun 8, 2019</td>
      ...
      <div class="modal fade modal-notif modal-slide" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel"
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">              <div class="list-group list-group-flush my-n3">
                ...
                <div class="list-group-item bg-transparent">
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                      <small><strong>Widgets are updated successfull</strong></small>                      <div class="my-0 text-muted small">Just create new layout Index, form, table</div>
