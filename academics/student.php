...
<head>
  ...
  <title>Student Profile - Rinda AMS</title>
  <!-- Simple bar CSS -->
                        ...
                        <div class="row ">
                          ...
                          <div class="row mb-2">
                            ...
                            <form class="m-1" action="manage_parents.php" method="post">
                              ...
                              <button type="submit" class="btn mb-2 btn-outline-secondary">Manage Parents</button>
                            </form>
                            <form class="m-1" action="class_management.php" method="post">
                              <input type="hidden" name="admission_no" value="<?php echo $admission_no; ?>">
                              <button type="submit" class="btn mb-2 btn-outline-success">Manage Class</button>
                            </form>
                            <form class="m-1" action="disable_student.php" method="post">
                              <input type="hidden" name="admission_no" value="<?php echo $admission_no; ?>">
                              <button type="submit" class="btn mb-2 btn-outline-danger">Disable Student</button>
                            </form>
