                  ...
                  <div class="card shadow mb-4">
                    <div class="card-body">
                      ...
                      <div class="form-check mb-2">
                        <input class="form-check-input required" type="radio" name="sendOption" required id="sendToEmail"
                          value="sendToEmail">
                        <label class="form-check-label" for="sendToEmail">Send to Email</label>
                      </div>
                      <div class="form-check mb-2">
                        <input class="form-check-input required" type="radio" name="sendOption" required id="sendToWhatsApp"
                      ...
                      <div class="form-check mb-2">
                        <input class="form-check-input required" type="radio" name="sendOption" required id="sendToEmailWhatsApp"
                          value="sendToEmailWhatsApp">
                        <label class="form-check-label" for="sendToEmailWhatsApp">To Email & WhatsApp</label>
                      </div>
                      <div class="form-check mb-2">
                        <input class="form-check-input required" type="radio" name="sendOption" required id="sendBySMSWhatsApp"
                          value="sendBySMSWhatsApp">
                        <label class="form-check-label" for="sendBySMSWhatsApp">By SMS and WhatsApp</label>
                      </div>
                      <div class="form-check mb-2">
                        <input class="form-check-input required" type="radio" name="sendOption" required id="sendBySMSEmail"
                          value="sendBySMSEmail">
