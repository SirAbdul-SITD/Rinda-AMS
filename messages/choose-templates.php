                    ...
                    <div class="accordion w-100" id="accordion1">
                      <div class="card shadow">
                        <div class="card-header" id="heading1">
                          <a style="text-decoration: none;" role="button" href="#collapse1" data-toggle="collapse"
                            data-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                            <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit?</strong>
                          </a>
                        </div>
                        <div id="collapse1" class="collapse show  pb-4" aria-labelledby="heading1"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading2">
                          <a style="text-decoration: none;" role="button" href="#collapse2" data-toggle="collapse"
                        ...
                        <div id="collapse2" class="collapse  pb-4" aria-labelledby="heading2" data-parent="#accordion1">
                          <div class="card-body"> Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                            ...
                            Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird
                            on it squid single-origin coffee nulla assumenda shoreditch et. </div>
                          <a href="#" style="text-decoration: none;" class="col-12 ml-2 mb-5 text-right">Choose <i
                              class=" fe fe-arrow-right"></i></a>
                        </div>
                      </div>
                      <div class="card shadow">
                        <div class="card-header" id="heading3">
                          <a style="text-decoration: none;" role="button" href="#collapse3" data-toggle="collapse"
                    ...
                    <div class="accordion w-100" id="accordion2">
                      <div class="card shadow">
                        <div class="card-header" id="heading4">
                          <a style="text-decoration: none;" role="button" href="#collapse4" data-toggle="collapse"
                            data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                            <strong>Massa eget egestas purus viverra accumsan in nisl?</strong>
                          </a>
                        </div>
                        <div id="collapse4" class="collapse show  pb-4" aria-labelledby="heading4"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading5">
                          <a style="text-decoration: none;" role="button" href="#collapse5" data-toggle="collapse"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading6">
                          <a style="text-decoration: none;" role="button" href="#collapse6" data-toggle="collapse"
                    ...
                    <div class="accordion w-100" id="accordion3">
                      <div class="card shadow">
                        <div class="card-header" id="heading7">
                          <a style="text-decoration: none;" role="button" href="#collapse7" data-toggle="collapse"
                            data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                            <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit?</strong>
                          </a>
                        </div>
                        <div id="collapse7" class="collapse show  pb-4" aria-labelledby="heading7"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading8">
                          <a style="text-decoration: none;" role="button" href="#collapse8" data-toggle="collapse"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading9">
                          <a style="text-decoration: none;" role="button" href="#collapse9" data-toggle="collapse"
                    ...
                    <div class="accordion w-100" id="accordion4">
                      <div class="card shadow">
                        <div class="card-header" id="heading10">
                          <a style="text-decoration: none;" role="button" href="#collapse10" data-toggle="collapse"
                            data-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                            <strong>Massa eget egestas purus viverra accumsan in nisl?</strong>
                          </a>
                        </div>
                        <div id="collapse10" class="collapse show  pb-4" aria-labelledby="heading10"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading11">
                          <a style="text-decoration: none;" role="button" href="#collapse11" data-toggle="collapse"
                      ...
                      <div class="card shadow">
                        <div class="card-header" id="heading12">
                          <a style="text-decoration: none;" role="button" href="#collapse12" data-toggle="collapse"
