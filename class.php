                          ...
                          foreach ($classes as $index => $class): ?>
                            <tr>
                              ...
                              <td>
                                ...
                                $stmt = $pdo->prepare($query);
                                $stmt->bindParam(':class', $class_name, PDO::PARAM_STR);
                                $stmt->execute();
                                $classes = $stmt->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <form class="needs-validation" novalidate>
                      ...
                      if (count($sections) === 0) {
                        ...
                        <div class="custom-control custom-radio">
                          <input type="radio" id="<?= $section['section']; ?>" name="section" value="<?= $section['section']; ?>" class="custom-control-input" required>
