                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body p-4">
                    <form>
                      ...
                      <div class="form-row">
                        <div class="form-group col-12">
                          <label for="eventType">Subject</label>
                          <select id="eventType" class="form-control select2">
                            <option value="work">select</option>
                            <option value="home">Home</option>
                          </select>
                  ...
                  <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate>
                      <div class="form-group">
                        <input type="text" class="form-control" id="ClassName" placeholder="Subject Title" required>
                      ...
                      if (count($classes) === 0) {
                        ...
                        foreach ($classes as $class): ?>
                          <div class="custom-control custom-radio">
                            <input type="radio" id="<?= $classes['class']; ?>" name="section"
                              value="<?= $classes['class']; ?>" class="custom-control-input" required>
                            <label class="custom-control-label" for="<?= $classes['class']; ?>"><?= $classes['class']; ?>
                              Section</label>
                          </div>
                        <?php endforeach;
                      } ?>
