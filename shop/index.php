...
GROUP BY MONTH(order_date)";
        ...
        GROUP BY 
          ...
          <div class="row">
            ...
            //             // Prepare the SQL query
//             $sql = "SELECT s.*, CONCAT(p.firstName, ' ', p.lastName) AS parent_name 
// FROM store_activity s 
// INNER JOIN parents p ON s.user_id = p.id 
                    ...
                    <div class="pb-3 timeline-item item-success">
                      <div class="pl-5">
                        <div class="mb-1 small"><strong>@
                            <?php echo htmlspecialchars($activity['parent_name']); ?>
                          </strong>
                          <?php echo htmlspecialchars($activity['activity']); ?>
                        </div>
                        <p class="small text-muted">
                          <?php echo htmlspecialchars($activity['create_datetime']); ?>
