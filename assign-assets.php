...
<head>
  ...
  <title>Assigned Assets - Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item active dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="asset-management-elements">
              ...
              <li class="nav-item">
                <a class="nav-link pl-3 text-primary" href="assign-assets.php"><span class="ml-1 item-text">Assigned Assets</span></a>
              </li>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="row align-items-center my-3">
              <div class="col">
                <h3 class="page-title">Assigned Assets</h3>
              </div>
              <div class="col-auto">
                        ...
                        <tr>
                          ...
                          <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              ...
                              <a class="dropdown-item" href="#">Un-Assign</a>
                            </div>
                          </td>
                        </tr>
                        <!-- Row 2 -->
