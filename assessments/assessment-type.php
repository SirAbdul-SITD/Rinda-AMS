            ...
            <div class="modal-body">
              <form id="newForm">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-6">
                    ...
                    <select id="deadline" class="form-control select2 required" required name="deadline" required>
                      <?php
                      $weeks = array('1 week', '2 week', '2 week', '3 week', '4 week', '5 week', '6 week', '7 week', '8 week', '9 week', '10 week', '11 week', '12 week');
                      echo "<option value=''>Select deadline Week</option>";
                      foreach ($weeks as $week):
                        echo "<option value=$week>$week</option>";
                      endforeach;
                      ?>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-6">
                    <label for="class-id" class="col-form-label">Total Marks</label>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#typeSaveBtn').on('click', function () {
        console.log('clicked');
        var newTitle = $('#assessment_type-name').val();
        var designationSalary = $('#total_marks').val();
        var department = $('#class-id').val();
