        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item active dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="study-materials-elements">
              ...
              <li class="nav-item">
                <a class="nav-link pl-3 text-primary" href="videos.php"><span class="ml-1 item-text">Videos</span></a>
              </li>
              <li class="nav-item">
                          ...
                          <div class="card-body file">
                            <div class="file-action">
                              ...
                              <div class="dropdown-menu m-2">
                                ...
                                <a class="dropdown-item download" href="download-video.php?id=<?= $video['id']; ?>"><i
                            ...
                            <button type="button" class="btn btn-link" data-toggle="modal" data-target="#yourModal"
                              data-src="file-manager/videos/<?= $video['title'] ?>.<?= $video['extension'] ?>">
                              ...
                              <div class="file-info">
                                <span class="badge badge-light text-muted mr-2 vid-subject"
                                  id="vidsubject-<?= $video['id'] ?>"><?= $video['subject'] ?></span>
                                <span class="badge badge-pill badge-light text-muted vid-class"
                                  id="vidclass-<?= $video['id'] ?>"><?= $video['class'] ?></span>
                              </div>
                            </button>
                                  ...
                                  <div class="modal-body">
                                    <div class="video-container">
                                      <video id="videoPlayer" class="video-js vjs-default-skin" controls preload="auto">
                                        <source src="file-manager/videos/<?= $video['title'] ?>.<?= $video['extension'] ?>"
