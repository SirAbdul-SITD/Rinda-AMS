        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item active dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="account-elements">
              ...
              <li class="nav-item">
                <a class="nav-link pl-3 text-primary" href="expense.php"><span class="ml-1 item-text">Expense</span></a>
              </li>
            </ul>
          </li>
          <!-- Attendance -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tr>
                          ...
                          <tr>
                              ...
                              <td>3</td>
                              <td>SS2 Science Project Expenses</td>
                              <td>05 Sep 2022</td>
                              <td>John Doe</td>
                              <td>$ 30.00</td>
                              <td>
