...
<html lang="en">
  <head>
    ...
    <title>Lesson Content - Rinda AMS</title>
    <!-- Simple bar CSS -->
        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              ...
              <p>This page includes a range of contrasting styles that support the needs of your content modifications.</p>
              ...
              <div class="row mb-4">
                <div class="col-md-12">
                  <div class="card shadow">
                    <div class="card-body">
                      <h5 class="card-title"><?= $subject -> $topic -> $subtopic ?></h5>
